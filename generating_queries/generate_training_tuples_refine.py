...
def check_in_test_set(northing, easting, points, x_width, y_width):
    ...
    for point in points:
        if (
            point[0] - x_width < northing
            and northing < point[0] + x_width
            and point[1] - y_width < easting
            and easting < point[1] + y_width
        ):
            in_test_set = True
            break
    return in_test_set
...
base_path = "/lyh/benchmark_datasets"
...
construct_query_dict(df_train, base_path + "/training_queries_refine.pickle")
